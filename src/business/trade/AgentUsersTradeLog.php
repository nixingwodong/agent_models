...
namespace agent_models\business\trade;

use agent_models\business\finance\money\AgentUserMoneyLog;
use agent_models\business\finance\money\AgentUsersMoneyTransferAccountsLog;
use agent_models\database\AgentUsersMoneyRechargeLog;
...
class AgentUsersTradeLog extends \agent_models\database\AgentUsersTradeLog
{
    use YiiModelTrait;
    ...
    public static function getOrderCates()
    {
        return [
            self::ORDER_CATE_RECHARGE_MOBILE    => [
                'name'  => '手机话费充值' , 'order_model' => \agent_models\database\OrderMobileRecharge::class ,
                'route' => [
                    'order_details' => '/order/mobile-recharge/details' ,
                ] ,
            ] ,
            self::ORDER_CATE_RECHARGE_FLOW      => [
                'name'  => '手机流量充值' , 'order_model' => \agent_models\database\OrderMobileRecharge::class ,
                'route' => [
                    'order_details' => '/order/flow-recharge/details' ,
                ] ,
            ] ,
            self::ORDER_CATE_RECHARGE_TELEPHONE => [
                'name'  => '固话宽带充值' , 'order_model' => \agent_models\database\OrderTelephoneRecharge::class ,
                'route' => [
                    'order_details' => '/order/telephone-recharge/details' ,
                ] ,
            ] ,
            self::ORDER_CATE_RECHARGE_TENCENT   => [
                'name'  => '腾讯业务充值' , 'order_model' => \agent_models\database\OrderTencentRecharge::class ,
                'route' => [
                    'order_details' => '/order/tencent-recharge/details' ,
                ] ,
            ] ,
            self::ORDER_CATE_RECHARGE_GAME      => [
                'name'  => '游戏点卡充值' , 'order_model' => \agent_models\database\OrderGameRecharge::class ,
                'route' => [
    ...
    public static function getPaymentMethod()
    {
        return [
            ...
            self::PAYMENT_METHOD_BALANCE         => [
                ...
                'name'       => '余额支付' ,
                'modelsName' => '\agent_models\money\recharge\way\AlipayTransfer' ,
            ] ,
