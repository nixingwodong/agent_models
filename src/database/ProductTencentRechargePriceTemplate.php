...
/**
 * This is the model class for table "{{%product_tencent_recharge_price_template}}".
 *
 * @property int $id
 ...
 */
class ProductTencentRechargePriceTemplate extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return '{{%product_tencent_recharge_price_template}}';
    }
