...
namespace common\models\business\finance\rebate;

use common\models\business\order\recharge\OrderRechargeAll;

class AgentUsersRebateLog extends \common\models\database\AgentUsersRebateLog
{
